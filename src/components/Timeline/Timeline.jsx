const Timeline = () => {
    ...
    return (
        <div className="w-full bg-orange-600 flex flex-col justify-center items-center py-10">
            <span className='w-max self-start px-32 pb-10'>
                <h1 className='text-3xl w-min text-white font-bold m-5 underlined-text lg:text-6xl'>TIMELINE</h1>
            </span>
